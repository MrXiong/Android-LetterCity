...
public class CityLetterSortView extends View {
	// 触摸事件
	...
	public CityLetterSortView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public CityLetterSortView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
